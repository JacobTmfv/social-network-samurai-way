...
const SET_TOGGLE_FOLLOW_IN_PROGRESS = 'SET_TOGGLE_FOLLOW_IN_PROGRESS'
...
let usersReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case SET_TOGGLE_FOLLOW_IN_PROGRESS:{
            return {
...
export const setToggleFollowInProgress = (isFetching, userId) => ({type: SET_TOGGLE_FOLLOW_IN_PROGRESS, isFetching, userId})
